  ...
  return (
    <>
      <Grid
        ...
        className={
          currentUser._id === msg.from._id ? classes.current : classes.other
        }
      >
        <Avatar
          src={
        ...
        />
        <span className={currentUser._id === msg.from._id}>
      ...
      >
        <Paper
          ...
          style={{
            ...
            marginLeft: currentUser._id === msg.from._id ? 0 : theme.spacing(5),
          }}
        >
          <div className={classes.content}>
            <Typography variant="h6">{ReactEmoji.emojify(msg.body)}</Typography>
          </div>
        </Paper>
        <br />
      </Grid>
      <Grid
        ...
        style={{
          marginLeft: currentUser._id === msg.from._id ? 0 : theme.spacing(6),
        }}
      >
